...
- MailProgramming 서비스가 일시 중단되었습니다..ㅜㅜ
...
27. [2019-07-08.py](https://github.com/sprumin/Mailprogramming/blob/master/2019-07-08.py)
...
28. [2019-07-08_2.py](https://github.com/sprumin/Mailprogramming/blob/master/2019-07-08_2.py)
...
29. [2019-07-09.py](https://github.com/sprumin/Mailprogramming/blob/master/2019-07-09.py)
    - 달팽이는 낮에 A만큼 올라가고 저녁에 B만큼 미끄러져내려온다.
    - 목표인 V높이까지 며칠이 걸리는지 출력하세요.
    - 낮에 V높이만큼 도달했다면 더이상 미끄러지지않습니다.
30. [2019-07-09_2.py](https://github.com/sprumin/Mailprogramming/blob/master/2019-07-09_2.py)
...
31. [2019-07-09_3.py](https://github.com/sprumin/Mailprogramming/blob/master/2019-07-09_3.py)
